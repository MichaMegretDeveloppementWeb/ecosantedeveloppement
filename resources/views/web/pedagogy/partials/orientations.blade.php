@php
    $orientations = [
        ...
        ['num' => '02', 'illu' => 'feuille', 'title' => "L'apprentissage des comportements favorables à la santé et au bien-être", 'text' => "Repas bio préparés sur place, respect des rythmes de sommeil, hygiène douce, premiers gestes du quotidien\u{00A0}: l'enfant apprend par l'exemple et par l'expérience, dans un climat bienveillant."],
        ...
        ['num' => '04', 'illu' => 'coeur',   'title' => "L'établissement de liens avec les services de santé et la communauté environnante", 'text' => 'Suivi PMI, partenariats avec professionnels de santé, ouverture sur le quartier, lien intergénérationnel. La crèche n\'est jamais isolée de son écosystème, elle s\'y inscrit pleinement.'],
    ];
@endphp
