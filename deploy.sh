...
# Script de déploiement — ecosantedeveloppement
# Usage:        ./deploy.sh
...
REPO_URL="https://github.com/MichaMegretDeveloppementWeb/ecosantedeveloppement.git"
...
echo "============================================"
echo "  Déploiement ecosantedeveloppement"
echo "============================================"
